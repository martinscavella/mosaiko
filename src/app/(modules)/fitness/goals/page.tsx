      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Set and track your fitness objectives</p>
          </div>
        ...
        <div className="mt-8 bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20 text-center">
          <div className="text-6xl mb-4">🎯</div>
          <h3 className="text-xl font-semibold text-white mb-2">Set Your Fitness Goals</h3>
          <p className="text-gray-400 mb-6">Whether it&apos;s losing weight, building muscle, or running a marathon</p>
